// this is the worst jquery plugin ever written
// do NOT ever try to use this POS
...
//    var result = {},
//      $element = this;
//    $j.each(attributes.split(/\s/), function() {
...
//      switch(command) {
//      case "add":
//        $j.extend(existingRules, jQuery.validator.normalizeRule(argument));
